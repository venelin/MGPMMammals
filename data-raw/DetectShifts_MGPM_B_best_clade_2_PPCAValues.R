...
#
# bsub -M 400000 -n 400 -W 23:59 -R ib sh R --vanilla --slave -f ../../DetectShifts_MGPM_B_best_clade_2_PPCAValues.R
#
library(ape)
library(PCMBase)
library(PCMBaseCpp)
...
prefixFiles = paste0("MGPM_B_best_clade_2_PPCAValues")
...
fitMappings <- PCMFitMixed(
  ...
  argsConfigOptim2 = DefaultArgsConfigOptim(
    ...
    numJitterRootRegimeFit = 2000L,
    sdJitterRootRegimeFit = 0.05,
    numJitterAllRegimeFits = 2000L,
